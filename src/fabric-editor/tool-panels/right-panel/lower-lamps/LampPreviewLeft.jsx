...
const LampPreviewLeft = () => {
    ...
    return (
        <>
            <svg width="250px" height="240px" viewBox="0 0 475 662" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <image href={images.length ? images[1].url : ''} x="71" y="64" width="331" height="465" preserveAspectRatio="none"/>
