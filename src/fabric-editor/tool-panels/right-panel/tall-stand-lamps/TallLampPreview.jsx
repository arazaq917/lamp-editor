    ...
    return (
        <>
            <svg width="250" height="240" viewBox="0 0 475 662" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M305 584H169V612C169 612 178.5 629 237 629C295.5 629 305 612 305 612V584Z" fill="url(#paint0_linear_12_1040)"/>
                <ellipse cx="237" cy="583.5" rx="68" ry="17.5" fill="url(#paint1_radial_12_1040)"/>
                <ellipse cx="237" cy="583.5" rx="68" ry="17.5" fill="url(#paint2_linear_12_1040)" fill-opacity="0.2"/>
                <rect x="232" y="312" width="10" height="272" fill="url(#paint3_linear_12_1040)"/>
                <image href={images.length ? images[0].url : ''} x="140" y="42" width="196" height="264"preserveAspectRatio="none"/>
                ...
                <defs>
                    <linearGradient id="paint0_linear_12_1040" x1="169" y1="607" x2="305" y2="607" gradientUnits="userSpaceOnUse">
                    ...
                    <radialGradient id="paint1_radial_12_1040" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(237 583.5) rotate(90) scale(17.5 68)">
                    ...
                    <linearGradient id="paint2_linear_12_1040" x1="237" y1="569" x2="237" y2="595.5" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#BABABA"/>
                        <stop offset="0.318728" stop-color="#DDDDDC"/>
                        <stop offset="0.591727" stop-color="#E2E2E2"/>
                        <stop offset="1" stop-color="#E9E9E9"/>
                    </linearGradient>
                    <linearGradient id="paint3_linear_12_1040" x1="232" y1="448" x2="242" y2="448" gradientUnits="userSpaceOnUse">
                    ...
                    <linearGradient id="paint4_linear_12_1040" x1="138.783" y1="173.589" x2="336.124" y2="173.589" gradientUnits="userSpaceOnUse">
