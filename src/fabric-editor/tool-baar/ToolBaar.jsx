        ...
        <div className={`toolbaar-container`}>
            {textProps&&
                <>
                    ...
                    <span className="buttons_style" onClick={changeAlignment}>
                        <img
                            src={changeAlign === 'left' ? leftAlign : changeAlign === 'right' ? rightAlign : changeAlign === 'center' ? centreAlign : format}
                            alt="left" height={24} width={24}/>
                    </span>
                    <div className="font_family_size">
                        <select
                            className='family_select_inlineStyle'
                        ...
                        <select
                            className='size_select_inlineStyle'
                            value={changeSize}
